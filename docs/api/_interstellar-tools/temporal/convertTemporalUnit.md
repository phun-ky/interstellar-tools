...
Defined in:
[convert-temporal-unit.ts:96](https://github.com/phun-ky/interstellar-tools/blob/61f8695341d00f6ef7d231a7e105d43d667ebbd5/packages/temporal/src/convert-temporal-unit.ts#L96)
...
| ------------ | ---------------------------------------------------- | ---------------------------------------------------- |
| `time`       | [`TemporalInterface`](../types/TemporalInterface.md) | Input duration `{ value, unit }` in canonical units. |
| `targetUnit` | [`TemporalUnitType`](../types/TemporalUnitType.md)   | Desired canonical output unit (will be normalized).  |

## Returns

[`TemporalInterface`](../types/TemporalInterface.md)
