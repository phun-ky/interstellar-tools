...
[@interstellar-tools/equations](../equations.md) / computeAngle
...
Defined in:
[compute-angle.ts:77](https://github.com/phun-ky/interstellar-tools/blob/61f8695341d00f6ef7d231a7e105d43d667ebbd5/packages/equations/src/compute-angle.ts#L77)
...
| ---------- | ---------------------------------------------------- | --------------------------------------------------------- |
| `body`     | [`CelestialBodyType`](../types/CelestialBodyType.md) | The celestial body for which to compute the true anomaly. |
| `timeStep` | [`TimeStepInterface`](../types/TimeStepInterface.md) | The time step in days since the last frame.               |
