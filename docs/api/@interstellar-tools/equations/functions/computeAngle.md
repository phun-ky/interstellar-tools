...
Defined in:
[angle/compute-angle.ts:77](https://github.com/phun-ky/interstellar-tools/blob/a64e834c86c544c4daa99be2e8cd850a0ff7183c/packages/equations/src/categories/angle/compute-angle.ts#L77)
