...
Defined in:
[angle/compute-angle.ts:77](https://github.com/phun-ky/interstellar-tools/blob/bc82c0b064eb62a197cb347f04d9cd13adf6e2cf/packages/equations/src/categories/angle/compute-angle.ts#L77)
