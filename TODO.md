...
# Planetary Cartography & Mapping (cheat sheet)

## Reference bodies & coordinates

**Spherical / Ellipsoidal**

- Sphere radius: \(R\)
- Oblate spheroid: equatorial \(a\), polar \(c\), flattening \(f=\frac{a-c}{a}\)
- Triaxial ellipsoid: \( \frac{x^2}{a^2}+\frac{y^2}{b^2}+\frac{z^2}{c^2}=1 \)

**Planetocentric vs. Planetographic latitude**

- Planetocentric: \( \varphi_c = \arctan\!\frac{z}{\sqrt{x^2+y^2}} \)
- Planetographic (oblate; east-positive longitudes): \( \tan\varphi_g =
  \frac{z}{\sqrt{x^2+y^2}}\,(1-e^2)^{-1} \), \( e^2 = 1-\frac{c^2}{a^2} \)

**Body-fixed ↔ inertial (IAU rotation)**

- Right ascension/declination of pole \( (\alpha_p,\delta_p) \), prime meridian
  \( W(t) \)
- Direction cosine matrix \( \mathbf R\_{\text{BF}\leftarrow\text{ICRF}} =
  \mathbf R_3(W)\,\mathbf R_1(90^\circ-\delta_p)\,\mathbf R_3(90^\circ+\alpha_p)
  \)
